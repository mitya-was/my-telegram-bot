...
const CONFIG = {
  ...
  // Налаштування форми - відповідність колонок (НОВА СТРУКТУРА)
  FORM_FIELDS: {
    ...
    CLIENT_DIRECTOR: 3,     // Колонка D - ПІБ директора/представника замовника
    ...
    PERFORMER: 15           // Колонка P - ПІБ виконавця (ФОП)
  },
